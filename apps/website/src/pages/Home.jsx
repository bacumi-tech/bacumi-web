...
import { brand, roadmap, solutionTracks } from '../content/siteCopy';
    ...
    <div className="page-shell">
        ...
        <div className="page-header px-6 py-12 md:px-10 md:py-16">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link to="/solutions" className="btn-primary h-12 px-8 text-sm md:text-base">
      ...
      <section className="soft-section mt-12 py-16">
        <div className="layout-container">
          <div className="mx-auto mb-9 max-w-3xl text-center">
            <h2 className="text-3xl font-bold md:text-4xl">Focused product families</h2>
            <p className="mt-4 text-lg text-slate-600">A live engineering product today and two deliberately bounded product steps ahead.</p>
          </div>
          <div className="grid gap-6 md:grid-cols-2">
            <article className="surface-card p-7">
              ...
              <h3 className="text-2xl font-bold">{solutionTracks[0].title}</h3>
              <p className="mt-3 text-slate-600">{solutionTracks[0].description}</p>
            ...
            <article className="surface-card p-7">
              ...
              <h3 className="text-2xl font-bold">{solutionTracks[1].title}</h3>
              <p className="mt-3 text-slate-600">{solutionTracks[1].description}</p>
              <ul className="mt-5 space-y-2 text-sm text-slate-700">
                <li className="flex items-start gap-2"><FileSpreadsheet size={16} className="mt-0.5 text-accent" /> Excel-first import and export</li>
                <li className="flex items-start gap-2"><BadgeCheck size={16} className="mt-0.5 text-accent" /> Romania and VIES verification scope</li>
                <li className="flex items-start gap-2"><Clock3 size={16} className="mt-0.5 text-accent" /> Design-partner validation before build</li>
              </ul>
            </article>
          </div>
        </div>
      ...
      <section className="layout-container mt-14">
        <div className="section-block px-6 py-10 text-center md:px-10">
          <h2 className="text-3xl font-bold md:text-5xl">Ready to explore Bacumi solutions?</h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600">Start with PR Pulse today or help shape one of the bounded products planned next.</p>
