      ...
      <section className="layout-container">
        <div className="page-header px-6 py-12 text-center md:px-10">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg text-slate-600 md:text-xl">
            Bacumi SRL builds focused software for teams that want clearer workflows and better execution.
          </p>
        </div>
      </section>
      ...
      <section className="layout-container mt-12">
        <div className="section-block p-7 md:p-9">
          ...
          <p className="mt-4 text-slate-600">
            PR Pulse for Azure DevOps is the live flagship product, with Treefold and Tagfold, two free Azure DevOps extensions, coming soon. Future products carry a clear stage and are shaped through focused early-access and design-partner conversations before availability.
          </p>
        </div>
      </section>
    </div>
